...
regions <- list(
  amazon = c("BRA","PER","COL","ECU","BOL","VEN","GUY","SUR","GUF"),
  congo = c("COD","COG","GAB","CMR","CAF","GNQ","AGO","RWA","BDI"),
  indomalay = c("IDN","MYS","BRN","SGP","PHL","THA","VNM","KHM","LAO","MMR","TLS","PNG"))
...
# New Guinea regions
download_keys$amazon <- download_gbif_occurrences(regions$amazon, "Amazon")
download_keys$congo <- download_gbif_occurrences(regions$congo, "Congo Basin")
download_keys$indomalay <- download_gbif_occurrences(regions$indomalay, "Indo-Malay")
